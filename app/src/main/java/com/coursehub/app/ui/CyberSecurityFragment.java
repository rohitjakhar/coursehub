...
public class CyberSecurityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_cyber_security, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Cyber").orderBy("timeStamp", Query.Direction.DESCENDING).get()
