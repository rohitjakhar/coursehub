...
public class LifeStyleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_life_style, container, false);
    ...
    private void loadData() {
        ...
        db.collection("LifeStyle").orderBy("timeStamp", Query.Direction.DESCENDING).get()
