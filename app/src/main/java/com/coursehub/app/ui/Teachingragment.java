 ...
 */
public class Teachingragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_teachingragment, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Teaching").orderBy("timeStamp", Query.Direction.DESCENDING).get()
