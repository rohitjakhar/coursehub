...
public class DevelopmentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_development, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Development").orderBy("timeStamp", Query.Direction.DESCENDING).get()
