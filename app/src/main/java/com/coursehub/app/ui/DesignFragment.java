...
public class DesignFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_design, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Design").orderBy("timeStamp", Query.Direction.DESCENDING).get()
