...
public class PersonalityFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_personality, container, false);
    ...
    private void loadData() {
        ...
        db.collection("PD").orderBy("timeStamp", Query.Direction.DESCENDING).get()
