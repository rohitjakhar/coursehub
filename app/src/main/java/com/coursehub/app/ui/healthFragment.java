...
public class healthFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_health, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Health").orderBy("timeStamp", Query.Direction.DESCENDING).get()
