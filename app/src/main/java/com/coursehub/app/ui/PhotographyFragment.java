...
public class PhotographyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_photography, container, false);
    ...
    private void loadData() {
        ...
        db.collection("Photography").orderBy("timeStamp", Query.Direction.DESCENDING).get()
