...
public class SoftwareFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_software, container, false);
    ...
    private void loadData() {
        ...
        db.collection("IT").orderBy("timeStamp", Query.Direction.DESCENDING).get()
